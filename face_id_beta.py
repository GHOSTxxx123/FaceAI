...
outputs = model_final.fit_generator(gen, steps_per_epoch=60, epochs=100, validation_data = val_gen, validation_steps=40)
...
model_final.load_weights('faceid_big_rgbd_2.h5')
...
print(model_final.predict([inp1, inp2]))